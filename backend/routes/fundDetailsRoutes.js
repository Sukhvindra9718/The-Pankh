...
const {addfundDetails, getAllfundDetails, getFundDetailByID, deleteFundDetails, updateFundDetails,getAllFundDetailsCount} = require("../controllers/fundController");
...
router.get('/fundDetails',authMiddleware.authenticationMiddleware,authMiddleware.superAdminMiddleware, getAllfundDetails)
...
router.get('/fundDetails',authMiddleware.authenticationMiddleware,authMiddleware.adminMiddleware, getAllfundDetails)
