...
router.get('/contact/count',authMiddleware.authenticationMiddleware,authMiddleware.superAdminMiddleware, commonController.getAllContactUsCount)
...
router.get('/keycontact/count',authMiddleware.authenticationMiddleware,authMiddleware.superAdminMiddleware, commonController.getAllkeyContactCount)
...
router.get('/contact/count',authMiddleware.authenticationMiddleware,authMiddleware.adminMiddleware, commonController.getAllContactUsCount)
...
router.get('/keycontact/count',authMiddleware.authenticationMiddleware,authMiddleware.adminMiddleware, commonController.getAllkeyContactCount)
