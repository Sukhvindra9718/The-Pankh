            ...
            <>
                <section className="two-section">
                    <div className="two-section__wrapper">
                        <div className="two-section__left wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms" style={{backgroundImage: 'url('+publicUrl+'images/backgrounds/two-section-left-bg.jpg)'}}>
                        ...
                        <div className="two-section__right wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms" style={{backgroundImage: 'url('+publicUrl+'images/backgrounds/two-section-right-bg.jpg)'}}>
                            <div className="two-section__content-box">
