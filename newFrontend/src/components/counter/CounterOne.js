        ...
        return (
            <>
                <section className="counter-one">
                    <div className="counter-one-bg jarallax" data-jarallax data-speed="0.2" data-imgposition="50% 0%" style={{backgroundImage: 'url('+publicUrl+'images/backgrounds/counter-one-bg.jpg)'}}></div>
