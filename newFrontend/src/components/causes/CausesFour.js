            ...
            <div className="row">
              ...
              >
                ...
                <div className="causes-one__single">
                  <div className="causes-one__img">
                    <img
                      src={publicUrl + "assets/images/resources/causes-1-1.jpg"}
                      alt=""
                    />
                  </div>
              ...
              >
                ...
                <div className="causes-one__single">
                  <div className="causes-one__img">
                    <img
                      src={publicUrl + "assets/images/resources/causes-1-2.jpg"}
                      alt=""
                    />
                  </div>
                  <div className="causes-one__content-box">
              ...
              >
                ...
                <div className="causes-one__single">
                  <div className="causes-one__img">
                    <img
                      src={publicUrl + "assets/images/resources/causes-1-3.jpg"}
                      alt=""
                    />
                  </div>
                  <div className="causes-one__content-box">
